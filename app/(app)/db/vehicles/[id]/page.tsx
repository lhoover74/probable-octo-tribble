...
import { updateSqliteVehicleAction } from "@/lib/sqlite-actions";
import { readVehicleFromSqlite } from "@/lib/server/sqlite-vehicle-store";
import { formatDateTime } from "@/lib/utils";

export default async function DbVehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const updateAction = updateSqliteVehicleAction.bind(null, id);
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
      <div className="space-y-6">
        ...
        <SectionCard title="Update database record" description="Saving here writes to SQLite and appends to the activity log.">
      ...
      <div className="space-y-6">
        <SectionCard title="Photos" description="Database-linked evidence entries for this record.">
        ...
        <SectionCard title="Activity timeline" description="Chronological database-backed audit log.">
