...
export default function LiveNewVehiclePage() {
  const property = properties[0];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-semibold text-white">Live Add Vehicle</h1>
        <p className="mt-2 text-sm text-slate-400">This form saves directly into the file-backed vehicle store.</p>
      </div>

      <SectionCard title="Create live record" description="Submitting this form writes a new record and redirects to its live detail page.">
