...
import { readVehicleById } from "@/lib/server/vehicle-store";
import { formatDateTime } from "@/lib/utils";

export default async function LiveVehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
      <div className="space-y-6">
        ...
        <SectionCard title="Update live record" description="Saving here updates the file-backed store and appends to the activity log.">
      ...
      <div className="space-y-6">
        <SectionCard title="Activity timeline" description="Chronological log from the file-backed store.">
